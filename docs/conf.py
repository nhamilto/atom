...
# -*- coding: utf-8 -*-
#
# ATom: acoustic tomography of the atomsphere documentation build configuration file, created by
# sphinx-quickstart on Fri Sep  7 11:03:44 2018.
#
...
latex_documents = [
    (master_doc, 'ATomacoustictomographyoftheatomsphere.tex',
     'ATom: acoustic tomography of the atomsphere Documentation',
     'Nicholas Hamilton, James Hansen', 'manual'),
]
